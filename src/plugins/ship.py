...
async def _(bot:Bot,event:MessageEvent,state:T_State):
    ...
    if  msg.lower() == "查大力神".lower() or "查HerculesStarlifter".lower() == msg.lower():
        path=os.path.split(os.path.realpath(__file__))[0] + '/ship/C2 Hercules Starlifter.jpg'
        await find.send(MessageSegment.image(path))
    ...
    if "查CSV".lower() in msg.lower() or "查SM".lower() == msg.lower() or "查CSVMS".lower() in msg.lower() or "查CSV-MS".lower() in msg.lower():
    ...
    if "查大黄蜂幽灵MK2".lower() in msg.lower() or "查幽灵黄MK2".lower() in msg.lower() or "查鬼黄MK2".lower() in msg.lower() or "查隐黄MK2".lower() in msg.lower() or "查大黄蜂幽灵MKII".lower() in msg.lower() or "查隐黄MKII".lower() in msg.lower() or "查 F7C-S Hornet Ghost Mk II".lower() in msg.lower():
