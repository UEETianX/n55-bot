...
async def handle_function(args: Message = CommandArg()):
    #await FINDID.finish("查ID会导致程序卡死，正在想办法解决这个问题")
    ...
    try:
        ...
        await FINDID.finish("未找到玩家，是不是输错啦？"+MessageSegment.file_image(Path(__file__).parent / path))
    else:
...
#                    print(imgs[i])
#            imgs[2]="C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/img/NONEdes.png"
#        else:
...
#                    imgs[i]='https://robertsspaceindustries.com'+imgs[i]
#                    print(imgs[i])
#            imgs[1]="C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/img/NONEORG.png"
...
#                print(imgs[i])
    ...
    card_path = 'C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/cardmuban'+str(n)+'.jpg'
    ID_path = imgs[0]
    org_path = imgs[2]
    des_path= imgs[1]
    print(des_path)
    ...
    try:
        ...
        image = Image.open("C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/img/NONEID.png")
    ...
    def circle_corner(img, radii):
        ...
        img.save('C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/ID.png','PNG',qulity=100)
        return img

    if n>6 :
        img = circle_corner(image, radii)
    else:
        image.save('C:\\Users\\Administrator\\Desktop\\Qbot\\n55-q/src/plugins/ID.png','PNG',qulity=100)
    ID = cv2.imread('C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/ID.png', cv2.IMREAD_UNCHANGED)
    ...
    try:
        ...
        img = Image.open("C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/img/NONEORG.png")
    w = img.size[0]
    h = img.size[1]
    w += 2*2
    h += 2*2
    ...
    if img.mode=="L":
        img=img.convert("RGB")
    img.save('C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/org.png')
    print("ID处理完成")
    org = cv2.imread('C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/org.png', cv2.IMREAD_UNCHANGED)
    ...
    try:
        ...
        image = Image.open("C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/img/NONEdes.png")
    image.save('C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/des.png')
    des = cv2.imread('C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/des.png', cv2.IMREAD_UNCHANGED)
    if args.lower()=="MolaACG".lower():
        des = cv2.imread('C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/molacg.png', cv2.IMREAD_UNCHANGED)
    ...
    image.save('C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/findID.png')
    
    path = os.path.split(os.path.realpath(__file__))[0] + '/findID.png'
    await FINDID.finish(MessageSegment.file_image(Path(__file__).parent / path))
