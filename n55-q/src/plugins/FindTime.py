...
async def handle_function(args: Message = CommandArg()):
    alist=pd.read_table("C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/alist.xls",encoding="gbk")
    msg=str(args)
    ...
    if any(msg in item for item in alist.PLACN):
        ...
        linenum=len(loc)
        just_open("C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/test.xlsx")
        wb = openpyxl.load_workbook("C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/test.xlsx",data_only=True)
        sheet = wb.active
        llist=[]
        for cell in sheet["A"]:
            llist=llist+[cell.value]
        img = Image.new("RGB",(1750,(100+100*linenum)),(255,248,220))
        img.save("C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/time.jpg")
        date = cv2.imread("C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/time.jpg", cv2.IMREAD_UNCHANGED)
        ...
        #img = cv2.resize(img, (800, (100+100*linenum)*800/1750))
        cv2.imwrite('C:\\Users\\Administrator\\Desktop\\Qbot/n55-q/src/plugins/time.jpg', img)
        path = os.path.split(os.path.realpath(__file__))[0] + '/time.jpg'
        await findtime.finish(MessageSegment.file_image(Path(__file__).parent / path))
