...
#    f=open("C://Users/Administrator/Desktop/Qbot/n55/src/plugins/tiebalist.txt","r+")
#    linktext = f.readline()
        ...
        if len(imglinks) == 0:
            ...
            for i in range(len(imglinks)):
                ...
                if i == 0:
                    ...
                    image.save('C://Users/Administrator/Desktop/Qbot/n55/src/plugins/tiebaimg'+str(i)+'.png')
                    imgstr="path"+str(i)+"='C://Users/Administrator/Desktop/Qbot/n55/src/plugins/tiebaimg"+str(i)+".png'"
                    exec(imgstr)
                    ...
                    imgstr="path"+str(i)+"='C://Users/Administrator/Desktop/Qbot/n55/src/plugins/tiebaimg"+str(i)+".png'"
                    exec(imgstr)
                    cmdstr = cmdstr + " + text_list[" + str(i) + "]" + " + MessageSegment.image(path=path" + str(i) + ")"
            if len(imglinks) < len(text_list):
                cmdstr = cmdstr + " + text_list[-1]"
        sendwd = sendwd + eval(cmdstr)
        if x==0:
